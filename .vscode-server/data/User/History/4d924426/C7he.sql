SELECT 
  distinct 
  keyword.segments_date,
  keyword.ad_group_criterion_keyword_text,
  campaign.campaign_name,
  ad_group.ad_group_name,
  --ad_group_criterion.system_serving_status,
  keyword.ad_group_criterion_keyword_match_type,
  --ad_group_criterion.approval_status,
  --ad_group_criterion.final_urls,
  --keyword.metrics_cost_micros
  keyword.metrics_clicks as clicks,
  keyword.metrics_impressions as impressions,
  keyword.metrics_ctr as ctr,
  --metrics_average_cpc,
  ROUND((CAST(keyword.metrics_cost_micros AS DECIMAL) / 1000000.0), 3) as cost
