{{
    config(
        ...
        unique_key = ['segments_date', 'ad_group_id', 'ad_group_ad_type', 'ad_group_ad_status', 'campaign_status', 'segments_ad_network_type', 'ad_group_status', 'campaign_id', 'customer_id', 'ad_group_ad_id'],
